...
function Start_page($$payload) {
  $$payload.out.push(`<div class="xcontainer svelte-92eur2"><div class="svelte-92eur2"><div class="main svelte-92eur2"><figure class="image is-128x128 svelte-92eur2"><img${attr("src", logo)} alt="OpenFusionAPI" class="svelte-92eur2"/></figure></div> <h1 class="title svelte-92eur2"><div class="svelte-92eur2"><span class="span01 svelte-92eur2"${attr_style(`background-image: url( ${stringify(flame)});`)}>OpenFusionAPI</span></div></h1> <div class="has-text-centered has-text-weight-bold svelte-92eur2"><span class="span01 svelte-92eur2"${attr_style(`background-image: url( ${stringify(flame)});`)}><a href="/openfusionapi" class="svelte-92eur2">ENTER</a></span></div></div></div>`);
}
